      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto space-y-8 mb-32">
          ...
          <ScrollReveal delay={0.1}>
            <ShimmerCard className="glass-card p-8 rounded-2xl border border-white/10 relative overflow-hidden">
          ...
          <ScrollReveal delay={0.5}>
            <ShimmerCard className="glass-card p-8 rounded-2xl border border-white/10 relative overflow-hidden bg-gradient-to-br from-electric-purple/10 to-neon-cyan/5">
              <div className="absolute top-0 right-0 p-4 opacity-10">

          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            <ScrollReveal delay={0.1}>
              <div className="space-y-8">
                <ShimmerCard className="glass-card p-8 rounded-2xl border border-white/10">
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <ScrollReveal delay={0.1}>
              <ShimmerCard className="glass-card p-6 rounded-xl border border-white/10 h-full">
      ...
      <section className="py-24 bg-white/5">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <ScrollReveal delay={0.2}>
              <ShimmerCard className="glass-card p-8 rounded-2xl border border-white/10 bg-black/40">
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <ScrollReveal delay={0.1}>
              <ShimmerCard className="glass-card p-8 rounded-2xl border border-white/10 h-full">

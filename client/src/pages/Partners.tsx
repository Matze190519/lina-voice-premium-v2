...
import { Check, Users, TrendingUp, ShieldCheck, Rocket, Globe, Play, Phone } from "lucide-react";
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <ShimmerCard className="glass-card border-border hover:border-primary/50 transition-all group">
              <CardHeader>
      ...
      <section className="py-24 bg-muted/30 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <ShimmerCard className="glass-panel p-8 rounded-2xl border border-white/10 relative">

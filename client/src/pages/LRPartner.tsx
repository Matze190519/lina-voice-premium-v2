    ...
    <div className="pb-20 pt-20">
      ...
      <section className="py-24 bg-deep-navy/30">
        <div className="container mx-auto px-4">
          <ScrollReveal>
            <ShimmerCard className="max-w-5xl mx-auto glass-card p-8 md:p-12 rounded-3xl border border-electric-purple/30 bg-deep-navy/50">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <ScrollReveal delay={0.1}>
              <ShimmerCard className="glass-card p-8 rounded-2xl border border-white/10 hover:border-neon-cyan/30 transition-colors h-full">
      ...
      <section className="py-24 bg-deep-space">
        <div className="container mx-auto px-4 max-w-5xl">
          <ScrollReveal>
            <ShimmerCard className="glass-card p-10 rounded-3xl border border-electric-purple/30 bg-deep-navy/50">
